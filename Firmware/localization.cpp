...
public:
    ...
    string update(long left_ticks, long right_ticks, float imu_heading)
    {
        ...
        return "X=" + to_string(x) + ", Y=" + to_string(y) + ", angle=" + to_string(imu_heading);
    }

    float getX() const { return x; }
    float getY() const { return y; }
    float getHeading() const { return prev_imu_heading; }
